export const projectData = [{
    ...
    slug: "FILA_India",
    heading: "FILA India",
    content: "International sportswear giant Fila was established in Biella, Italy in 1911, nestled among the foothills of the Italian Alps. A worldwide leader in sporting and lifestyle shoes and apparel, Fila champions its heritage Italian design DNA while simultaneously pushing the boundaries of modern performance wear.",
    objective: "Fila India launched their first e-commerce website on October 2017. Designed as per their international standards, the website had all the exclusive features of an e-commerce site.",
    challenges: "Though we had a reference to the design we were expected to achieve, but the development needed a lot of technical masterminds to achieve a backend that would cater from order to delivery and stock management systems.",
    solution: "Designed from scratch, the website had the classy Fila look- modern, international and sporty. The UI covered the classic and exclusive features of an e-commerce site with product display, description and cost. It helped in easy selection, a direct and trouble-free purchase, payment and delivery tracking. We simplified and organized their data feeding in the backend with auto generation of SKU-Ids to product thumbnailing to product details. The complex backend development simplified tasks for Fila team with a user-friendly interface as it captured every data in its simplest form, from order to after-sale process.",
    logo: "/logo/logo_fila.png",
    images: ["/casestudies/cs_fila01.png", "/casestudies/cs_fila02.png", "/casestudies/cs_fila03.png", "/casestudies/cs_fila04.png", "/casestudies/cs_fila05.png","/casestudies/cs_fila06.png","/casestudies/cs_fila07.png"]
},]