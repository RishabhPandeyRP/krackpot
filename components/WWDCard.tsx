...
const WWDCard = ({ data }: {
    ...
    return (
        <div className="sm:w-[750px] sm:h-[850px] w-[340px] h-[600px] border-0 border-[#01193D]">
            ...
            <div className="w-[100%] h-[100%] pl-[6%]">
                <div className="w-[90%] sm:w-[50%] h-[5%] border border-[#01193D]  relative mt-[6%] bg-[#01193D] pl-[3%]">
